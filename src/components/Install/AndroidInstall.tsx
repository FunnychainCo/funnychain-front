...
class AndroidInstall extends Component<{
    classes: any
}, { activeStep: number }> {
                ...
                >
                    <div key={"1"} style={{flexGrow: 1, display: "flex", justifyContent: "center", flexDirection: "column",margin:"10%"}}>
                        <div style={{textAlign: "center", fontSize: "1.1em"}}>
                            <img style={{flexGrow: 1,maxWidth:"100%",maxHeight:"100%"}} src="/static/image/install/android-1.png" alt="install" />
                            <br/>
                            <b style={{fontSize: "1.3em"}}>Tap the "menu" button on the top right of the browser window.</b><br/>
                        </div>
                    </div>
                    <div key={"2"} style={{flexGrow: 1, display: "flex", justifyContent: "center", flexDirection: "column",margin:"10%"}}>
                        <div style={{textAlign: "center", fontSize: "1.1em"}}>
                            <img style={{flexGrow: 1,maxWidth:"100%",maxHeight:"100%"}} src="/static/image/install/android-2.png" alt="install" />
                            <br/>
                            <b style={{fontSize: "1.3em"}}>Choose "Add to home screen"</b><br/>
                        </div>
                    </div>
                    <div key={"3"} style={{flexGrow: 1, display: "flex", justifyContent: "center", flexDirection: "column",margin:"10%"}}>
                        <div style={{textAlign: "center", fontSize: "1.1em"}}>
                            <img style={{flexGrow: 1,maxWidth:"100%",maxHeight:"100%"}} src="/static/image/install/android-3.png" alt="install" />
                            <br/>
...
export default withStyles(styles)(AndroidInstall);